...
public class GrenadeThrow : MonoBehaviour
{
    ...
    private void Explode()
    {
        ...
        UnityEngine.Collider[] objectsInRange = Physics.OverlapSphere(transform.position, explosionRadius);
        ...
        for (int i = 0; i < objectsInRange.Length; i++)
        {
            ...
            else
            {
                ...
                if (objectsInRange[i].GetComponent<Rigidbody>() != null)
                {
                    ...
                    objectsInRange[i].GetComponent<Rigidbody>().AddForceAtPosition(forceDirection * explosionForce + Vector3.up * explosionForce, transform.position + new Vector3(0,-0.5f,0), UnityEngine.ForceMode.Impulse);
